...
public class Jeopardy implements ActionListener {
	...
	public void run() {
		...
		panel = createHeader("Jeapardy Game");
	...
	public void actionPerformed(ActionEvent e) {
		...
		if (buttonPressed == firstButton) {
			askQuestion("What lane does the ADC go to in League of Legends?", "bot lane", 200);
		}
		...
		if (buttonPressed == secondButton) {
			askQuestion("How many agents are in Valorant?", "14", 400);
		}
